// One-time SEED values for the clinic-settings document. Used ONLY by the migration
// script (server/migrations/v2/seed-clinic-settings.ts) to provision the DB row — never
