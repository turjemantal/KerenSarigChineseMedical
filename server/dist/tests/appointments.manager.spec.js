...
const appointments_manager_1 = require("../src/appointments/appointments.manager");
const appointments_service_1 = require("../src/appointments/appointments.service");
...
describe('AppointmentsManager', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                appointments_manager_1.AppointmentsManager,
                { provide: appointments_service_1.AppointmentsService, useValue: mockService },
            ],
        }).compile();
        manager = module.get(appointments_manager_1.AppointmentsManager);
        jest.clearAllMocks();
    });
    describe('book', () => {
        it('creates and returns a new appointment', async () => {
            mockService.create.mockResolvedValueOnce(appt1);
            const dto = { phone: '0501111111', name: 'Alice', date: '2026-05-01', time: '09:00' };
        ...
        it('passes all optional fields through to service', async () => {
            const dto = { phone: '0501111111', name: 'Alice', date: '2026-05-01', time: '09:00', concern: 'כאב גב', notes: 'ללא גלוטן' };
...
//# sourceMappingURL=appointments.manager.spec.js.map